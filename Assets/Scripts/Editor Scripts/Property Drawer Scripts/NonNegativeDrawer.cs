...
namespace Happy
{
	...
	public class NonNegativeDrawer : PropertyDrawer
	{
		...
		public override void OnGUI (Rect position, SerializedProperty property, GUIContent label)
		{
			...
			EditorGUI.LabelField (position, new GUIContent ("NonNegative Field"), GUIStyleExtension.CommentLabel);
			position.height += EditorGUIUtility.singleLineHeight;
			...
			switch (property.propertyType)
			{
				...
				default:
					EditorGUI.LabelField (position, label.text, "Use NonNegative attribute with int or float field!");
					break;
			}
		}
	}
